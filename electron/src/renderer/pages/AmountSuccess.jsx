  ...
  return (
    <div className="font-light p-6 flex flex-col justify-between min-h-screen gap-y-4">
      ...
      <main className="p-4 flex flex-col justify-center items-center gap-2">
        <Link to={"/home"} className='flex gap-2 justify-center items-center bg-pink-100 p-2 rounded-xl shadow-2xl shadow-zinc-200 cursor-pointer hover:scale-[1.015] transition-all duration-500 ease-in-out'>
          ...
          <div className='text-xl text-pink-800'>Balance Added Successfully</div>
        </Link>
        <div className='text-xl font-light text-pink-800 opacity-50'>
          Redirecting...
        </div>
      </main>
      <Footer />
