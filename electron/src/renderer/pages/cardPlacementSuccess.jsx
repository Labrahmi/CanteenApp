      ...
      <Header />
        <main className="p-4 flex flex-col justify-center items-center gap-4">
              ...
              <div className="flex flex-col gap-4 min-w-[28rem] px-4">
                  <div className="flex flex-col">
                      <div className="flex items-center gap-4 rounded-xl">
                          ...
                          <div className="">
                            <h1 className="font-semibold text-xl">{ user ? user.name : "unkown" } <span className="font-light"> / { user ? user.id : "0000" }</span></h1>
                            <h2>Role: <span className="font-semibold">{ user ? user.role : "unkown" }</span></h2>
                            <h2>Card ID: <span className="font-semibold">{ user ? user.card_id : "0000" }</span></h2>
                          </div>
                      </div>
          ...
          <div className="flex gap-2">
              <Link to="/" className="flex gap-2 justify-center items-center text-xl px-4 font-semibold bg-zinc-100 hover:bg-zinc-200 p-2 border border-zinc-900 rounded">
                  <div>
              ...
              <Link to="./amount-selection" className="flex gap-2 hover:gap-3 justify-center items-center text-xl px-4 font-semibold bg-green-100 hover:bg-green-200 p-2 border border-green-900 rounded transition-all ease-in-out">
