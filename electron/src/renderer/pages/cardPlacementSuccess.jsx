    ...
    <div className="font-light p-6 flex flex-col justify-between min-h-screen gap-y-4">
      ...
      <main className="p-4 flex flex-col justify-center items-center gap-4">
        ...
        <div className="flex gap-2">
          <Link to={"/home"} className="flex gap-2 justify-center items-center text-xl px-4 font-semibold bg-zinc-100 hover:bg-zinc-200 p-2 border border-zinc-900 rounded-xl">
            <div>
          ...
          <Link to={`./amount-selection?username=${user.username}`} className="flex gap-2 hover:gap-3 justify-center items-center text-xl px-4 font-semibold bg-pink-100 hover:bg-pink-200 p-2 border border-green-900 rounded-xl transition-all ease-in-out">
