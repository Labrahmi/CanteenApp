            ...
            <div>
              <div className="flex flex-col">
                <div className="flex items-center gap-4 rounded-xl">
                    ...
                    <div className="">
                        <h1 className="font-semibold text-xl">Youssef Labrahmi <span className="font-light"> / SN63</span></h1>
                ...
                <input
                  onChange={(e) => {
                    ...
                    if (e.target.value.length > 0) {
                      setCustomClasses("bg-zinc-50 p-3 rounded-lg border flex justify-center items-center gap-x-2 font-thin my-2 transition-all ease-in-out duration-200 bg-green-500 text-white font-bold");
                    } else {
